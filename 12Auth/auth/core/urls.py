...
# self - GET - 获取自身资料
SELF_DETAIL_URL = API_ROOT + '/people/self'

# people - GET - 详情
PEOPLE_DETAIL_URL = API_ROOT + '/people/{}'
...
PEOPLE_LIKED_LIVES_URL = API_ROOT + '/lives/people/{}/like_lives'
...
ANSWER_DETAIL_URL = API_ROOT + '/answers/{}'
...
# question - GET - 详情
QUESTION_DETAIL_URL = API_ROOT + '/questions/{}'
...
# topic - GET - 详情
TOPIC_DETAIL_URL = API_ROOT + '/topics/{}'
...
COLLECTION_DETAIL_URL = API_ROOT + '/collections/{}'
...
# column - GET - 详情
COLUMN_DETAIL_URL = API_ROOT + '/columns/{}'
...
ARTICLE_DETAIL_URL = API_ROOT + '/articles/{}'
...
SEND_COMMENT_URL = API_ROOT + '/comments'

# me.delete - DELETE - 删除评论
COMMENT_DETAIL_URL = API_ROOT + '/comments/{}'
...
# live - GET - 详情
LIVE_DETAIL_URL = API_ROOT + '/lives/{}'
...
LIVE_ONGOING_URL = API_ROOT + '/lives/ongoing'

# client.lives_ended - GET - 所有已结束的 Live
# LiveTag.lives_ended - GET - 所有已结束的 Live (需要附加 query 参数 tags = <tagid>）
LIVE_ENDED_URL = API_ROOT + '/lives/ended'

# client.lives_ended - GET - 所有已结束的 Live
# LiveTag.lives_ended - GET - 所有已结束的 Live (需要附加 query 参数 tags = <tagid>）
LIVE_TAGS_URL = API_ROOT + '/lives/tags'
...
NOTIFICATION_CONTENTS_URL = API_ROOT + '/notifications/contents'

NOTIFICATION_LIKES_URL = API_ROOT + '/notifications/likes'

NOTIFICATION_FOLLOWS_URL = API_ROOT + '/notifications/follows'

# ----- 私信相关 -----

# me.whispers - GET - 获取用户私信对话列表
WHISPERS_URL = API_ROOT + '/inbox'

# whisper.messages - GET - 获取用户某一对话的消息列表
MESSAGES_URL = API_ROOT + '/messages'

# me.message - POST - 发送私信
SEND_MESSAGE_URL = API_ROOT + '/messages'

# ----- 搜索 -----
SEARCH_API_URL = API_ROOT + '/search_v3'

# ----- 其他操作 -----

# me.block - POST - 屏蔽用户
BLOCK_PEOPLE_URL = API_ROOT + '/settings/blocked_users'
...
"""
正则表达式与 :any:`ZhihuClient` 的方法的对应关系。
